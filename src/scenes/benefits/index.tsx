  ...
  return (
    <section id="benefits" className="mx-auto min-h-full w-5/6 py-8">
      ...
      >
        ...
        <div className="mt-16 items-center justify-between gep-20 md:mt-28 md:flex">
          {/* IMAGE */}
          <img
            className="mx-auto"
          ...
          <div>
            ...
            <div className="relative">
              <div className="before:absolute before:-t-20 before:-left-10 before:z-[-1] content-abstractwaves">
                <motion.div
                  initial="hidden"
                  whileInView="visible"
                  viewport={{ once: true, amount: 0.5 }}
